...
The Action Module is already integrated with the Flood framework through the [FloodCoreComponent](/pond/core#pre-built-components), so you can start using it right away in your Flood applications.
