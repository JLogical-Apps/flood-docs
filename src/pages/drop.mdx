...
These security rules can then be accessed and analyzed by Integrations, such as [Firebase](/firebase#automatic-firestore-security-rules-generation-and-deployment), to deploy security rules to the backend.
