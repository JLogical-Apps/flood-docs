...
-   `reference<EntityType>()`: A field that stores a String but indicates it references an `EntityType`. View [Reference Fields](#reference-fields) for more info on how they are used within auto-generated UI.
