...
```dart filename="example/lib/pages/login_page.dart" {4-36}
class LoginPage with IsAppPage<LoginRoute> {
  @override
  Widget onBuild(BuildContext context, LoginRoute route) {
    return StyledPage(
...
```dart filename="example/lib/pages/login_page.dart" {3,10-13}
import 'package:flood/flood.dart';
import 'package:flutter/material.dart';
...
```dart filename="example/lib/pages/login_page.dart" {13}
...
return StyledPage(
      body: SafeArea(
        bottom: false,
...
```dart filename="example/lib/pages/login_page.dart" {5-9}
...
StyledButton(
  labelText: 'Login',
  onPressed: () async {
...
```dart filename="example/lib/pages/login_page.dart" {10-13}
...
StyledButton(
  labelText: 'Login',
  onPressed: () async {
...
```dart filename="example/lib/pages/login_page.dart" {7-15}
...
final result = await loginPort.submit();
if (!result.isValid) {
  return;
...
```dart filename="example/lib/pages/signup_page.dart"
import 'package:flood/flood.dart';
import 'package:flutter/material.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
...
```dart filename="example/lib/pages/login_page.dart" {7}
...
try {
  final account = await context.authCoreComponent
      .login(AuthCredentials.email(email: data['email'], password: data['password']));
...
```dart filename="example/lib/pages/login_page.dart" {5}
...
StyledButton.strong(
  labelText: 'Sign Up',
  onPressed: () async {
...
```dart filename="example/lib/pages/signup_page.dart" {7}
...
try {
  final account = await context.authCoreComponent
      .signup(AuthCredentials.email(email: data['email'], password: data['password']));
...
```dart filename="example/lib/pages/home_page.dart" {3, 7, 9-15}
import 'package:flutter/material.dart';
import 'package:flood/flood.dart';
...
```dart filename="example/lib/pages/home_page.dart" {4,9}
...
@override
...
Update your `HomePage` in `example/lib/pages/home_page.dart`:

```dart filename="example/lib/pages/home_page.dart" {6-16}
@override
Widget onBuild(BuildContext context, HomeRoute route) {
  final loggedInUserId = useLoggedInUserIdOrNull();
  return StyledPage(
...
Create a new file `example/lib/pages/forgot_password_page.dart` with the following content:

```dart filename="example/lib/pages/forgot_password_page.dart"
import 'package:flood/flood.dart';
import 'package:flutter/material.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
...
Now, let's add a link to the Forgot Password page from our Login page. Update your `LoginPage` in `example/lib/pages/login_page.dart`:

```dart filename="example/lib/pages/login_page.dart" {8-14}
...
StyledObjectPortBuilder(port: loginPort),
StyledList.row.centered.withScrollbar(
  children: [
